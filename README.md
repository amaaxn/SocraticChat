...
**Render:**
- Build command: `cd backend && pip install --upgrade pip setuptools wheel && pip install fastapi uvicorn[standard] openai python-dotenv pydantic && pip install --only-binary spacy spacy && python -m spacy download en_core_web_sm`
