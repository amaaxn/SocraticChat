...
**Render:**
- Build command: `cd backend && pip install --upgrade pip setuptools wheel && pip install --only-binary :all: -r requirements.txt && python -m spacy download en_core_web_sm`
